...
- APN validation logic verified (no duplicates, all required APNs added)
...
- `tests/test_runner.py` - Comprehensive unit test suite, now includes APN validation tests
- `README.md` - Updated with APN test instructions
